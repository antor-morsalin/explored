...
<main class="min-h-screen flex items-center justify-center p-6">
  <section class="w-full max-w-md bg-white border border-slate-200 rounded-2xl shadow-sm p-8">
    ...
    <form action="/explored/login" method="POST" class="mt-6 space-y-4">
      <div>
      ...
      <p class="text-center text-sm text-slate-600">
        ...
        <a href="/register" class="font-semibold text-slate-900 underline underline-offset-4 hover:no-underline">
          Create one
        </a>
      </p>
    </form>
