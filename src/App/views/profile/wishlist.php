...
<div class="flex min-h-screen bg-slate-100 font-sans">
    ...
    <aside class="w-64 bg-slate-900 text-white flex flex-col flex-shrink-0 transition-all duration-300 hidden md:flex">
        ...
        <nav class="flex-1 py-6 flex flex-col gap-1 px-3">
            ...
            <a href="/explored/profile/wishlist" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-indigo-600 text-white shadow-md">
                <svg class="w-5 h-5 opacity-90" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
    ...
    <main class="flex-1 min-w-0 overflow-y-auto">
        <div class="max-w-5xl mx-auto px-6 sm:px-8 py-10">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-bold text-slate-900">My Wishlist</h2>
                <a href="/explored" class="text-sm font-medium text-pink-600 hover:text-pink-800 bg-pink-50 px-4 py-2 rounded-lg transition-colors">
                    Browse Places
                </a>
            </div>
