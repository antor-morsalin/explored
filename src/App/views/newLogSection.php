...
<main class="mx-auto max-w-3xl px-6 py-10">
    ...
    <form id="sectionForm" method="post" action="<?php echo "/explored/logs/{$logId}/new" ?>" class="space-y-7" novalidate>
        <div>
            ...
            <input id="place_name" name="place_name" type="text" class="mt-2 w-full rounded-xl border border-gray-300 px-4 py-2 focus:border-black focus:outline-none transition-colors" placeholder="e.g. Marina Bay Sands"/>
        ...
        <div>
            ...
            <input id="avg_cost" name="avg_cost" type="number" step="1" min="0" class="mt-2 w-40 rounded-xl border border-gray-300 px-4 py-2 focus:border-black focus:outline-none transition-colors" placeholder="e.g. 25"/>
            <p id="cost-error" class="mt-1 text-xs text-red-500 hidden"></p>
        </div>

        <div>
            <label class="block text-sm font-medium">Rating (out of 5)</label>
            <input id="rating" name="rating" type="number" min="1" max="5" class="mt-2 w-28 rounded-xl border border-gray-300 px-4 py-2 focus:border-black focus:outline-none transition-colors" placeholder="1–5"/>
